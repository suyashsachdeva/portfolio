window.DATA = {
  ...
  experience: [ {
    ...
    bullets: ["Designed a new architecture that improved accuracy on a non-uniform material dataset by 5%.", "Proposed a statistical–ML ensemble for adversarial-noise detection, reaching 94% accuracy."],
    ...
    bullets: ["Developed a facial-recognition model for accurate identification of known individuals.", "Built a voice-controlled DL pipeline to detect nearby known individuals and notify users."],
    tags: ["Vision", "Voice"]
  }],
  journals: [{
